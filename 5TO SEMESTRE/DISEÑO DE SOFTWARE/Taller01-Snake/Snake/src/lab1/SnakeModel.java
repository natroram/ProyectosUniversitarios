...
public class SnakeModel extends GameModel {
	...
	private static final GameTile SNAKE_TILE = new RectangularTile(new Color(141, 73, 37));

	/** Graphical representation of the snake's head */
	private static final GameTile SNAKE_HEAD_TILE = new RectangularTile(new Color(63,40,23));
